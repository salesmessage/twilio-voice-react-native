...
class Voice extends _eventemitter.EventEmitter {
  ...
  constructor() {
    ...
    _defineProperty(this, "_handleMissedCallNotificationTapped", nativeVoiceEvent => {
      if (nativeVoiceEvent.type !== _constants.Constants.VoiceEventMissedCallNotificationTapped) {
    ...
    this._nativeEventHandler = {
      ...
      [_constants.Constants.VoiceEventMissedCallNotificationTapped]: this._handleMissedCallNotificationTapped,
  ...
  canUseFullScreenIntent() {
    return _common.NativeModule.voice_canUseFullScreenIntent();
  }

  getLogs(timePeriod) {
    return _common.NativeModule.voice_getLogs(timePeriod);
  }
  /**
