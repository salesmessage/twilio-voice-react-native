...
export declare type NativeVoiceEvent = NativeAudioDevicesUpdatedEvent | NativeMissedCallNotificationTappedEvent | NativeCallInviteIncomingEvent | NativeErrorEvent | NativeRegisteredEvent | NativeUnregisteredEvent;
